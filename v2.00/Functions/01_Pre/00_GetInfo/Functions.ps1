...
.NOTES
    ...
    Link:	www.hornpa.de
    History:
    2017-05-21 - Added Language (PHo)
    2016-08-25 - Change Variable Name (PHo)
    2016-08-12 - Add Get-IniFile to read INI Files (PHo)
...
Process {
    ...
    $Message =  "Username: $env:USERNAME" + [System.Environment]::NewLine + ` 
                ...
                "GUI Language: $GUILanguage" + [System.Environment]::NewLine + `
                "Installed Languages: $InstalledLanguages" + [System.Environment]::NewLine + `
