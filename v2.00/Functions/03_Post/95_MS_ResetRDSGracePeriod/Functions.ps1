...
.NOTES
    ...
    History:
    2017-05-21 - Update Administrator Name detection (PHo)
...
"@ 
    ...
    # Get Local Administrator Group Name
    $ADM_Group = (get-wmiobject win32_group | Where-Object { ($_.Domain -like $env:COMPUTERNAME) -and ($_.SID -like "S-1-5-32-544")}).Name
